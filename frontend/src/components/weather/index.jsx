...
const WeatherWidget = ({ location }) => {
    ...
    useEffect(() => {
        if(location.length > 0){
            axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${location}&appid=69fe61a96d18bec1ecba74c0fe11a971&units=metric`)
            .then((response) => {
...
const cloudSize = weatherData.clouds.all;
  ...
  return (
    <div className="weather-widget">
      {isDayTime ? <div className="sun"></div> : <img src={MoonSvg} className="moon" alt="Moon" />}
      ...
      <div className="feels-like">Sensacao: {Math.round(weatherData.main.feels_like)}° </div>
